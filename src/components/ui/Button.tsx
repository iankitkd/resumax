...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ 
    ...
    const baseClasses = "inline-flex items-center justify-center rounded-full font-medium py-3 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 disabled:opacity-50 disabled:pointer-events-none";
