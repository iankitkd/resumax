      ...
      <div className="max-w-6xl mx-auto px-6 py-10">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
          <div>
            ...
            <p className="text-text-primary mt-1">{session.user.name ?? "User"}</p>
          ...
          <div className="flex gap-3">
            <Link
              href="/upload"
              className="bg-accent text-white px-5 py-2 rounded-lg hover:bg-accent-secondary transition"
            >
              Analyze Resume
            </Link>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
          <div className="bg-card p-6 rounded-xl shadow-sm border border-border">
            <p className="text-text-secondary text-sm">Total Resumes</p>
            <h2 className="text-3xl font-bold mt-2">{totalResumes}</h2>
          </div>

          <div className="bg-card p-6 rounded-xl shadow-sm border border-border">
            <p className="text-text-secondary text-sm">Latest Analysis</p>
